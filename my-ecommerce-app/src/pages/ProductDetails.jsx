                        ...
                        <div className="space-y-4">
                            {product.weight && (
                                <div className="flex flex-col sm:flex-row justify-between border-b pb-2">
                                    ...
                                    <span className="text-sm text-gray-500">{product.weight} {product.unit}</span>
                                </div>
                            )}
                            {product.additionalInfo && product.additionalInfo.length > 0 &&
                                product.additionalInfo.map((info, index) => (
                                    <div key={index} className="flex flex-col sm:flex-row justify-between border-b pb-2">
                                        <span className="text-sm font-medium text-gray-900">{info.key}</span>
