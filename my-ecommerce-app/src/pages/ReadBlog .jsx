...
const ReadBlog = () => {
  ...
  const fetchBlogData = () => {
    fetch(`https://afritabs-server.onrender.com/api/blogs/${id}`)
      .then((res) => res.json())
      .then((data) => {
        setBlog(data);
        setLoading(false);
  ...
  const fetchComments = () => {
    fetch(`https://afritabs-server.onrender.com/api/comments/${id}`)
      .then(res => res.json())
      .then(data => {
  ...
  const handleCommentSubmit = () => {
    if (newComment.name && newComment.text) {
      ...
      fetch('https://afritabs-server.onrender.com/api/comments', {
        method: 'POST',
        headers: {
