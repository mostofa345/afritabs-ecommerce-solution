    ...
    return (
        <>
            ...
            <MobileMenu 
                ...
                token={token} // ✅ token prop pass করা হয়েছে
                user={user} // ✅ user prop pass করা হয়েছে
                logout={handleLogout}
                cartItems={cartItems} // ✅ cartItems prop pass করা হয়েছে
            />
                ...
                <div className="container mx-auto px-4 py-3 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex gap-6 text-gray-700 z-30 items-center">
                        ...
                        {token ? (
                            <div className="relative" ref={dropdownRef}>
                                ...
                                {dropdownOpen && (
                                    <div className="absolute right-0 mt-2 w-40 bg-white border rounded-lg shadow-lg">
                                        ...
                                        <Link to="/mylist" className="block px-4 py-2 text-sm hover:bg-gray-100">My List</Link>
                            ...
                            <Link to="/login" className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition-colors">
                                Sign In
                            </Link>
                        )}
                    </nav>
