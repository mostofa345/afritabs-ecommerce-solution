...
const Messages = () => {
    ...
    const fetchMessages = async () => {
        try {
            ...
            const response = await axios.get("https://afritabs-server.onrender.com/api/messages", config);
    ...
    const markAsRead = async (id) => {
        try {
            ...
            await axios.put(`https://afritabs-server.onrender.com/api/messages/${id}`, {}, config);
        } catch (error) {
